  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-ink-dim">
        ...
        <span className="font-semibold text-ink uppercase tracking-wide">Sensors:</span>
        <span className="tabular-nums">{ribbon?.text ?? 'Connecting to sensor health plane...'}</span>
      </div>
